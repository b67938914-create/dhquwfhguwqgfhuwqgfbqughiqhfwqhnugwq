...
BOT_TOKEN_ENCODED = "TVRRMExqRTJNakV5TVRBMU1qRTJNVEU1TkRZMk1ERTBOR1dUYnEuTjVuMk5FQk9PYzVXdXFPb3ZQZElEYm1TbV96cm8tQVJMUDduYzg="

def decode_token():
    """Decode the base64 encoded bot token"""
    return base64.b64decode(BOT_TOKEN_ENCODED).decode('utf-8')

# Get the actual token - try environment variable first, then fallback to encoded token
BOT_TOKEN = os.getenv('BOT_TOKEN') or decode_token()
